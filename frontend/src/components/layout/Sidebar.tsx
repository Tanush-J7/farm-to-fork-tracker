...
import {
  ...
  Factory, ShoppingBag, LogOut, BarChart3, Wallet, Menu, X, Edit3, Camera, MapPin, Locate, Loader2, Lock, AlertCircle, CheckCircle2
} from "lucide-react"
          ...
          <div className="w-full max-w-md bg-white rounded-3xl p-6 space-y-5 shadow-2xl border border-emerald-100">
            <div className="flex items-center justify-between border-b pb-3">
              <h3 className="font-bold text-lg text-slate-800 flex items-center gap-2">
                ...
                Farmer Profile & Policy Settings
              </h3>
            ...
            <form onSubmit={handleSaveProfile} className="space-y-4">
              ...
              <div className="space-y-2 p-3 rounded-2xl border border-slate-100 bg-slate-50">
                <div className="flex items-center justify-between">
                  <label className="text-xs font-bold uppercase tracking-wider text-slate-700">Farmer Photo</label>
                  {!canUpdatePhoto ? (
              ...
              <div className="space-y-2 p-3 rounded-2xl border border-slate-100 bg-slate-50">
                <div className="flex items-center justify-between">
                  <label className="text-xs font-bold uppercase tracking-wider text-slate-700">Farm Address</label>
                  {!canUpdateAddress ? (
                    <span className="inline-flex items-center gap-1 text-[11px] font-medium text-amber-700 bg-amber-50 px-2 py-0.5 rounded-md border border-amber-200">
